...
# spaceflightsexample documentation build
...
from spaceflightsexample import __version__ as release

# -- Project information -----------------------------------------------------

project = "spaceflightsexample"
author = "Kedro"
...
htmlhelp_basename = "spaceflightsexampledoc"
...
latex_documents = [
    (
        master_doc,
        "spaceflightsexample.tex",
        "spaceflightsexample Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "spaceflightsexample",
        "Project spaceflightsexample codebase.",
        "Data-Science",
    )
]
